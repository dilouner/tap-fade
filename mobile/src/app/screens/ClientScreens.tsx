...
export function ClientHomeScreen() {
  ...
  return (
    <Screen eyebrow="TapFade" title={profile ? `Hola, ${profile.displayName.split(' ')[0] || 'bienvenido'}` : 'Tu próximo corte, sin llamadas'}>
...
export function ExploreScreen() {
  ...
  async function requestLocation() {
    ...
    if (permission.status !== 'granted') {
      setLocationMessage('Puedes buscar por nombre o zona sin compartir tu ubicación.');
      return;
    }
  ...
  if (loading) return <LoadingState />;
  return (
    <Screen eyebrow="Explorar" title="Encuentra tu lugar">
